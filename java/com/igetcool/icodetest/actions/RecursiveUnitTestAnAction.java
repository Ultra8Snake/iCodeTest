 ...
 * 当前类同级下所有类快速生成单元测试
 */
public class RecursiveUnitTestAnAction extends AnAction {

    @Override
    public void update(@NotNull AnActionEvent e) {
        String text = I18nUtils.recursiveAction();
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        ProcessorContext.create(OperateType.RECURSIVE).process(project, editor);
    }
